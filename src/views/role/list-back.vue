<template>
  <div class="app-container">
      ...
      <div>
        ...
        <el-table
          ...
          <el-table-column align="center" label="操作">
            <template slot-scope="scope">
              <span>
                <el-button type="mini" @click.stop="handleUpdate(scope.row.id)">编辑</el-button>
                <el-button type="mini" @click.stop="assignPermissions(scope.row.id)">权限</el-button>
              </span>
            </template>
          </el-table-column>
        </el-table>
    ...
    <el-collapse-transition>
      <el-dialog :visible.sync="permissionDialogForm.visible" :append-to-body="true" title="分配权限" width="30%">
